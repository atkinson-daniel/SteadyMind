...
RSpec.describe 'As a user' do
  it 'when I visit the stats page I see line graph' do
    ...
    mood4 = Mood.create(name: 'smile')
    mood5 = Mood.create(name: 'smile')
    ...
    mood_entry4 = UserMood.create(user_id: user.id, mood_id: mood4.id, created_at: 'Fri 29 May 2020 21:21:12 UTC +00:00', updated_at: 'Fri 29 May 2020 21:21:12 UTC +00:00')
    mood_entry5 = UserMood.create(user_id: user.id, mood_id: mood5.id, created_at: 'Sat 30 May 2020 21:21:12 UTC +00:00', updated_at: 'Sat 30 May 2020 21:21:12 UTC +00:00')
